                    ...
                    <tbody>
                        <?php foreach ($listProducts as $key => $product): ?>
                            <tr>
                                ...
                                <td> <center><img style="width:100px; height:120px" src="<?php echo $product['hinh_anh']; ?>" alt=""
                                ...
                                <td>
                                    ...
                                    if ($product['trang_thai'] == 1) {
                                        echo '<button class="btn btn-success">Đang bán</button>';
                                    } else {
                                        echo '<button class="btn btn-danger">Dừng bán</button>';
                                    }
                                    ?>
                                ...
                                <td>
                                    <a href="./?act=formUpdateSanPham&id_san_pham=<?php echo $product['id_san_pham']; ?>">
                                        <button class="btn btn-primary">Sửa</button>
                                    </a>
                                    <a href="./?act=deleteSanPham&id_san_pham=<?php echo $product['id_san_pham']; ?>">
