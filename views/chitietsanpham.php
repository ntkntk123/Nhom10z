...
<body>
    ...
    <div class="card mt-3 mb-3">
        <div class="row g-0">
            <div class="col-md-4">
                <img src="<?php echo $product['hinh_anh']; ?>" class="img-fluid rounded-start" alt="Product Image"
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <h1 class="card-title">Tên sản phẩm: <?php echo $product['ten_san_pham']; ?></h1>
                    <p class="card-text">Giá: <?php echo $product['gia']; ?></p>
                    <p class="card-text">Mô tả sản phẩm: <?php echo $product['mo_ta']; ?></p>
                    <label for="">Số lượng:</label>
                    <input type="number" value="1" class="form-control">
                    <div class="d-flex align-items-center">
                        <a href="product_detail.php?id=<?php echo $product['id_san_pham']; ?>"
                            class="btn btn-outline-primary">Mua ngay</a>
                        <button onclick="addToCart(<?php echo $product['id_san_pham']; ?>)"
        ...
        <h3>Bình luận</h3>
        <?php if (isset($_SESSION['username'])) : ?>
    <form action="?act=binhluan" method="POST" class="container-fluid p-4 bg-light rounded shadow-sm">
        <input type="hidden" name="id_san_pham" value="<?php echo htmlspecialchars($product['id_san_pham']); ?>">

        <div class="mb">
            <label for="noi_dung" class="form-label fw-bold">Nội dung bình luận:</label>
            <textarea 
                name="noi_dung" 
                id="noi_dung" 
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title text-primary">
                            <?php echo htmlspecialchars($comment['ten_khach_hang']); ?>
                        </h5>
