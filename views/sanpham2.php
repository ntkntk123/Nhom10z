                ...
                <?php foreach($listProducts as $product): ?>
                    <div class="col">
                        <div class="card h-100">
                            <a href="./?act=chitietsanpham&id_san_pham=<?php echo $product['id_san_pham']; ?>"><img width="225px" height="225px" src="<?php echo htmlspecialchars($product['hinh_anh']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($product['ten_san_pham']); ?>"
