        ...
        <?php foreach ($danhmucs as $danhmuc): ?>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4">
                <?php if (!empty($sanPhamDanhMuc[$danhmuc['id_danh_muc']])): ?>
                    <?php foreach ($sanPhamDanhMuc[$danhmuc['id_danh_muc']] as $product): ?>
                        <div class="col">
                            <div class="card h-100">
                                <a href="./?act=chitietsanpham&id_san_pham=<?php echo $product['id_san_pham']; ?>">
                                    <img style="width:375px; height:250px" src="<?php echo htmlspecialchars($product['hinh_anh']); ?>" 
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Giá: <strong><?php echo number_format($product['gia'], 0, ',', '.'); ?>
                                            VND</strong></p>
